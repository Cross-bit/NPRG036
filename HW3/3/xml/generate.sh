...
echo java -jar $saxonJar -xsl:"$xsltDir/toRdf-$fileNum.xslt" -s:"$xmlSrcDir/data-$fileNum.xml" -o:"$outputDir/data-$fileNum.ttl"

java -jar $saxonJar -xsl:"$xsltDir/toRdf-$fileNum.xslt" -s:"$xmlSrcDir/data-$fileNum.xml"  -o:"$outputDir/data-$fileNum.ttl"
